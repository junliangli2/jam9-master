...
switch(roomname)
{
	case "CreditScene":
		...
		draw_text(160, 510, "Textures: Tyrian Graphics");
		draw_text_transformed(60, 535, "http://www.lostgarden.com/search/label/free%20game%20graphics", 0.4, 0.4, 0);
		...
		draw_text_transformed(60, 750, "http://www.flashkit.com/imagesvr_ce/flashkit/soundfx/Ambience/laser-domson-8698/laser-domson-8698_hifi.mp3)", 0.4, 0.4, 0);
	...
	case "GameScene":
		...
		if (instance_exists(obj_boss))
			draw_text(x, y, "BOSS WINS");
		else
			draw_text(x, y, "PLAYER WINS");
